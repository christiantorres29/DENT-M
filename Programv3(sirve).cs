...
//        const int I2cBus = 1;
        ...
        //public static void i2conf(int sda, int sdb)
        //{
        ...
        static void Main(string[] args)
        {
            ...
            using Ssd1306 oled = new Ssd1306(i2cDevice_, Ssd13xx.DisplayResolution.OLED128x64);
            oled.ClearScreen();
